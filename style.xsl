...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:atom="http://www.w3.org/2005/Atom" xmlns:feedpress="http://feedpress.it/xmlns" version="1.0">
    ...
    <xsl:template match="/">
        <xsl:element name="html">
            <head>
                <title><xsl:value-of select="$title"/> — provided by FeedPress CHANGED</title>
                ...
                <div id="main">
                    ...
                    <div id="subscribe">
                        ...
                        <div id="readerslinks">
                            ...
                            <xsl:choose>
                                <xsl:when test="feedpress:locale='jp'">
                                    <a class="subscribe"
                                       href="http://rd.yahoo.co.jp/myyahoo/rss/addtomy/users/*http://add.my.yahoo.co.jp/rss?url={$feedUrl}">
                                        <img src="http://i.yimg.jp/i/jp/my/addtomy/standard_bb.gif" width="91"
                                             height="17" alt="My Yahoo!に追加"/>
                                    </a>
                                </xsl:when>
                                <xsl:otherwise>
