...
In the case of _How to Write a Git Commit Message_, someone else [posted a link](http://www.reddit.com/r/git/comments/2f5ojy/how_to_write_a_git_commit_message/) to it on the r/git subreddit. That resulted in more conversation and more traffic. I think in the future I'll refrain from posting my own material on Reddit; it seems more legitimate to let someone else do it.
